...
RUN:
    ...
    python demo_compare.py                       # 7B + qlora_adapter_7b
...
def parse_args():
    ...
    ap.add_argument("--adapter", default="qlora_adapter_7b")
    ap.add_argument("--share", action="store_true")
    in_notebook = "ipykernel" in sys.modules
    return ap.parse_args(["--model", "Qwen/Qwen2.5-VL-7B-Instruct",
                          "--adapter", "qlora_adapter_7b"] if in_notebook else None)

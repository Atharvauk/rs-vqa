...
Run:
    ...
    python step14_demo_app.py --load-4bit --adapter qlora_adapter_7b
...
NOTEBOOK_ARGS = ["--load-4bit", "--adapter", "qlora_adapter_7b"]
...
def parse_args():
    ...
    ap.add_argument("--adapter", default=None,
                    help="QLoRA adapter for best answers (e.g. qlora_adapter_7b)")
